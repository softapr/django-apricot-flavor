...
setup(
    name='django-apricot-flavor',
    version='0.0.1',
    packages=find_packages(exclude=["django_apricot_flavor"]),
    include_package_data=True,
    license='Apache-2.0 License',  # example license
    description='Apricot Flavor for Django.',
    long_description=README,
    url='https://github.com/softapr/django-apricot-flavor',
